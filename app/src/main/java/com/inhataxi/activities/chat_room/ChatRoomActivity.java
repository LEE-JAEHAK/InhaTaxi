...
public class ChatRoomActivity extends BaseActivity {
    ...
    void postChattingRoom() throws JSONException {
        ...
        /*
        params.put("startLongitude", Double.valueOf(mIntent.getExtras().getString("startLongitude")));
        params.put("startLatitude", Double.valueOf(mIntent.getExtras().getString("startLatitude")));
        params.put("endLongitude", Double.valueOf(mIntent.getExtras().getString("endLongitude")));
        params.put("endLatitude", Double.valueOf(mIntent.getExtras().getString("endLatitude")));
